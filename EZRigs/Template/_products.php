...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image'] ?? "./assets/products/img.png" ?>" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">EZ Rigs<br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    ...
                    <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Deliver to Customer - 400013</small>
                </div>
                <!-- !order-details -->
            ...
            <div class="col-12">
                ...
                <hr>
                <p class="font-rale font-size-14">NEXT GENERATION SOFTWARE
                    ...
                    Customize dozens of preset lighting profiles, experiment with a huge variety of user adjustable colors and adjust LED brightness to perfectly match your system.</p>
                <p class="font-rale font-size-14">MAXIMUM BANDWIDTH AND TIGHT RESPONSE TIMES
                    ...
                    Improves thermal conductivity for superb memory cooling even when overclocked.</p>
            </div>
        </div>
    </div>
</section>
